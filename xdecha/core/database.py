...
if "xdecha" in _RUN(_MGCLIENT.list_database_names()):
    _LOG.info(_LOG_STR, "xdecha Database Found :) => Now Logging to it...")
else:
    _LOG.info(_LOG_STR, "xdecha Database Not Found :( => Creating New Database...")

_DATABASE: AgnosticDatabase = _MGCLIENT["xdecha"]
