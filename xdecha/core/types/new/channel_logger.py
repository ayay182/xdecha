...
from xdecha.utils import SafeDict, get_file_id_of_media, parse_buttons
...
class ChannelLogger:
    """ Channel logger for xdecha """
    def __init__(self, client: Union['_client.xdecha', '_client.xdechaBot'], name: str) -> None:
    ...
    async def forward_stored(self,
                             client: Union['_client.xdecha', '_client.xdechaBot'],
                             message_id: int,
                             chat_id: int,
                             user_id: int,
        ...
        Parameters:
            client (`xdecha` | `xdechaBot`):
                Pass xdecha or xdechaBot.
