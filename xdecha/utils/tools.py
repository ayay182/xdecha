...
# https://github.com/ayay182/xdecha-Plugins/blob/master/plugins/tweet.py
def demojify(string: str) -> str:
    """ Remove emojis and other non-safe characters from string """
    return re.sub(_EMOJI_PATTERN, '', string)


def get_file_id_of_media(message: 'xdecha.Message') -> Optional[str]:
    """ get file_id """
...
# https://github.com/ayay182/xdecha-Plugins/blob/master/plugins/anilist.py
def post_to_telegraph(a_title: str, content: str) -> str:
    ...
    post_page = post_client.post(
        title=a_title,
        author=auth_name,
        author_url="https://t.me/thexdecha",
        text=content
    )
...
async def take_screen_shot(video_file: str, duration: int, path: str = '') -> Optional[str]:
    ...
    ttl = duration // 2
    thumb_image_path = path or os.path.join(xdecha.Config.DOWN_PATH, f"{basename(video_file)}.jpg")
