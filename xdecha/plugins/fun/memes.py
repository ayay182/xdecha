...
@xdecha.on_cmd("Oof$", about={'header': "Ooooof"},
               trigger='', allow_via_bot=False)
...
@xdecha.on_cmd("Hmm$", about={'header': "Hmmmmm"},
               trigger='', allow_via_bot=False)
...
@xdecha.on_cmd("clock$", about={'header': "kensar clock animation"})
...
@xdecha.on_cmd("(yes|no|maybe|decide)$", about={
