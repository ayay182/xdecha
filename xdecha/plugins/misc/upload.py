...
from xdecha import xdecha, Config, Message
from xdecha.utils import progress, take_screen_shot, humanbytes
from xdecha.utils.exceptions import ProcessCanceled
from xdecha.plugins.misc.download import tg_download, url_download

LOGGER = xdecha.getLogger(__name__)
CHANNEL = xdecha.getCLogger(__name__)

LOGO_PATH = 'resources/xdecha.png'


@xdecha.on_cmd("rename", about={
