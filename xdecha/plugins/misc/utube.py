...
@xdecha.on_cmd("ytinfo", about={'header': "Get info from ytdl",
...
@xdecha.on_cmd("ytdl", about={'header': "Download from youtube",
...
@xdecha.on_cmd("ytdes", about={'header': "Get the video description",
                               'description': 'Get information of the link without downloading',
