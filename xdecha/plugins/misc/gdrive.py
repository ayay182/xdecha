...
from xdecha import xdecha, Message, Config, get_collection, pool
from xdecha.utils import humanbytes, time_formatter
from xdecha.utils.exceptions import ProcessCanceled
from xdecha.plugins.misc.download import url_download, tg_download
...
_LOG = xdecha.getLogger(__name__)
...
class _GDrive:
    ...
    def _upload_file(self, file_path: str, parent_id: str) -> str:
        ...
        body = {"name": file_name, "mimeType": mime_type, "description": "Uploaded using xdecha"}
        if parent_id:
