...
@xdecha.on_cmd("vdelto", about={'header': "View auto message delete timeout"})
...
@xdecha.on_cmd("vwelto", about={'header': "View auto welcome/left message delete timeout"})
...
@xdecha.on_cmd("vapicto", about={'header': "View auto profile picture timeout"})
...
@xdecha.on_cmd("vesto", about={'header': "View edit sleep timeout"})
