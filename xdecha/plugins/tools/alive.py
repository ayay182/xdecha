...
from xdecha.utils import get_file_id_of_media
from xdecha import xdecha, Message, Config, versions, get_version, logging
...
"""
        ...
        copy_ = "https://github.com/ayay182/xdecha/blob/master/LICENSE"
        markup = InlineKeyboardMarkup([
            [
                InlineKeyboardButton(text="👥 xdecha", url="https://github.com/ayay182"),
