...
@xdecha.on_cmd("sudo", about={'header': "enable / disable sudo access"}, allow_channels=False)
...
@xdecha.on_cmd("vsudo", about={'header': "view sudo users"}, allow_channels=False)
...
@xdecha.on_cmd("vscmd", about={'header': "view sudo cmds"}, allow_channels=False)
